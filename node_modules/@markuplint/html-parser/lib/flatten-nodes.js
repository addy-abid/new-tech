        ...
        for (const node of nodeOrders) {
            ...
            if (endTag.nodeName.toLowerCase() === 'body' && prevToken.type === ml_ast_1.MLASTNodeType.Text) {
                ...
                if (prevWreckagesText) {
                    const wreckages = tag_splitter_1.default(prevWreckagesText.raw, prevWreckagesText.startLine, prevWreckagesText.startCol);
                    if (wreckages.length) {
    ...
    });
    {
        ...
        for (const node of result) {
            ...
            if (node.type === ml_ast_1.MLASTNodeType.Text) {
                ...
                if (parent && parent.type === ml_ast_1.MLASTNodeType.StartTag && parent.nodeName.toLowerCase() === 'html') {
