"use strict";
var _MLDOMToken_startLine, _MLDOMToken_endLine, _MLDOMToken_startCol, _MLDOMToken_endCol, _MLDOMToken_startOffset, _MLDOMToken_endOffset, _MLDOMToken_raw, _MLDOMToken_fixed;
Object.defineProperty(exports, "__esModule", { value: true });
const tslib_1 = require("tslib");
class MLDOMToken {
    constructor(astToken) {
        this.rules = {};
        _MLDOMToken_startLine.set(this, void 0);
        _MLDOMToken_endLine.set(this, void 0);
        _MLDOMToken_startCol.set(this, void 0);
        _MLDOMToken_endCol.set(this, void 0);
        _MLDOMToken_startOffset.set(this, void 0);
        _MLDOMToken_endOffset.set(this, void 0);
        _MLDOMToken_raw.set(this, void 0);
        _MLDOMToken_fixed.set(this, void 0);
...
exports.default = MLDOMToken;
_MLDOMToken_startLine = new WeakMap(), _MLDOMToken_endLine = new WeakMap(), _MLDOMToken_startCol = new WeakMap(), _MLDOMToken_endCol = new WeakMap(), _MLDOMToken_startOffset = new WeakMap(), _MLDOMToken_endOffset = new WeakMap(), _MLDOMToken_raw = new WeakMap(), _MLDOMToken_fixed = new WeakMap();
