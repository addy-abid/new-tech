...
class MLDOMElementCloseTag extends node_1.default {
    ...
    get raw() {
        ...
        if (this.nodeName !== tslib_1.__classPrivateFieldGet(this, _MLDOMElementCloseTag_fixedNodeName, "f")) {
            fixed = string_splice_1.stringSplice(fixed, tslib_1.__classPrivateFieldGet(this, _MLDOMElementCloseTag_tagOpenChar, "f").length, this.nodeName.length, tslib_1.__classPrivateFieldGet(this, _MLDOMElementCloseTag_fixedNodeName, "f"));
        }
        return fixed;
    }
    get rule() {
